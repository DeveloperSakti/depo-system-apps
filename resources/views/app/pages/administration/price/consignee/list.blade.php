...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
      ...
      <div class="breadcrumb-item">Consignee Price Table</div>
    </div>
  </div>

  <div class="section-body">
    <h2 class="section-title">Consignee Price Table</h2>
    <p class="section-lead">Tabel Data Consignee Price.</p>
      <div class="row">
            ...
            <div class="card-header">
             <div class="row" style="width:100%;">
                <div class="col-12 col-lg-2 col-md-2">
                  <a href="/administration/price/consignee/add" style="margin-left:1em;" class="btn btn-primary printbutton float-left"><span class=" fas fa-pencil-alt" ></span> Add</a>
                </div>
