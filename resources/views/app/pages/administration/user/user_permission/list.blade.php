    ...
    <div class="col-12 col-md-12 col-lg-12">
      <div class="card">
        <div class="card-header">
          <h4><button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus"></i> New User</a></h4>
      ...
      <form method="" action="">
        ...
        <div class="modal-body">
          <div class="card-body">
            ...
            <div class="form-group">
              <label class="d-block">Group Permission</label>
              <div class="form-text form-text-inline">
                  <input type="text" name="group_permission" class="form-control">
              </div>
            </div>
          </div>
        </div>
